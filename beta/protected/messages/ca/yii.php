...
return array (
  ...
  'Please fix the following input errors:' => 'Si us plau, corregiu els següents errors:',
  ...
  'The file "{file}" cannot be uploaded. Only files with these extensions are allowed: {extensions}.' => "L'arxiu {file} té una extensió no vàlida. Extensions acceptades: {extensions}.",
  'The file "{file}" is too large. Its size cannot exceed {limit} bytes.' => "L'arxiu {file} és massa gran. Tamany màxim permès: {limit} bytes.",
  ...
  '{attribute} "{value}" has already been taken.' => '{attribute} "{value}" ja està assignat.',
  '{attribute} cannot be blank.' => 'El camp {attribute} és obligatori.',
  '{attribute} is invalid.' => 'El camp {attribute} no és vàlid.',
  '{attribute} is not a valid URL.' => '{attribute} no es una URL vàlida.',
  '{attribute} is not a valid email address.' => '{attribute} no es un email vàlid.',
  ...
  '{attribute} must be a number.' => '{attribute} ha de ser un número.',
  '{attribute} must be an integer.' => '{attribute} ha de ser un número enter.',
  '{attribute} must be either {true} or {false}.' => '{attribute} ha de ser {true} o {false}.',
  '{attribute} must be greater than "{compareValue}".' => '{attribute} ha de ser més gran que "{compareValue}".',
  '{attribute} must be greater than or equal to "{compareValue}".' => '{attribute} ha de ser més gran o igual que "{compareValue}".',
  ...
  '{attribute} must be repeated exactly.' => '{compareAttribute} no coincideix amb {attribute}.',
